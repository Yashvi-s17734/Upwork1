  ...
  return (
    <section className="mx-auto max-w-7xl px-6 md:px-8 py-6 md:py-10 text-center">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="w-full bg-[#FAF6F0] rounded-[32px] p-8 md:p-12 border border-orange-100/50 flex flex-col items-center justify-center text-center shadow-2xs select-none min-h-[220px] transition-all duration-300">
          {/* Inner Badge */}
