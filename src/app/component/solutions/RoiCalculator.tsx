...
export default function RoiCalculator() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 md:px-8 py-6 md:py-10 text-center">
      ...
      <div className="max-w-4xl mx-auto bg-[#FAF6F0] rounded-[32px] p-6 md:p-10 border border-orange-100/50 shadow-2xs grid grid-cols-1 md:grid-cols-12 gap-8 items-center text-left mb-12">
