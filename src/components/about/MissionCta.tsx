  ...
  return (
    <section className="bg-white dark:bg-[#0d0d0e] py-16 md:py-24 transition-colors duration-300">
      <div className="mx-auto max-w-5xl px-6 md:px-8 space-y-16">
        ...
        {/* Call to Action Card */}
        <div className="rounded-[32px] bg-gradient-to-br from-[#FFF8F6] to-[#FFF] dark:from-[#171413] dark:to-[#121214] border border-orange-100 dark:border-orange-950/20 p-8 sm:p-12 text-center shadow-lg relative overflow-hidden transition-all duration-300">
          ...
          <div className="relative z-10 space-y-6 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
              <Link
                href="/request-demo"
                className="w-full sm:w-auto flex items-center justify-center gap-2.5 rounded-full bg-[#FF4F18] px-8 py-4 text-sm sm:text-base font-bold text-white transition-all duration-200 hover:bg-[#E03F0D] shadow-[0_8px_20px_rgba(255,79,24,0.25)] hover:shadow-[0_10px_24px_rgba(255,79,24,0.35)] hover:-translate-y-0.5 active:scale-[0.98]"
              >
              ...
              <Link
                href="/contact"
                className="w-full sm:w-auto flex items-center justify-center gap-2.5 rounded-full border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#121214] px-8 py-4 text-sm sm:text-base font-bold text-zinc-800 dark:text-zinc-250 transition-all duration-200 hover:bg-zinc-50 dark:hover:bg-zinc-900 active:scale-[0.98]"
              >
