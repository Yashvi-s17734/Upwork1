    ...
    <section className="bg-white dark:bg-[#0d0d0e] py-16 md:py-24 transition-colors duration-300">
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 rounded-3xl bg-[#F8F9FA] dark:bg-[#121214] border border-zinc-200/50 dark:border-[#2a2a2e]/40 p-6 sm:p-8 flex flex-col gap-8 shadow-sm">
            
            {/* BEFORE Section */}
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <span className="px-2 py-0.5 rounded-md bg-zinc-200 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 text-xs font-bold uppercase tracking-wider border border-zinc-300 dark:border-zinc-750">
                  Before
                </span>
                <h4 className="text-sm sm:text-base font-extrabold text-zinc-500 dark:text-zinc-450 uppercase tracking-wider">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                {beforeItems.map((item, idx) => (
                  <div
                    key={idx}
                    className="flex flex-col p-4 rounded-xl bg-white dark:bg-[#17171a] border border-zinc-200 dark:border-zinc-800/80 shadow-xs hover:border-[#FF4F18]/50 transition-colors"
                  >
                    <span className="text-sm font-bold text-zinc-900 dark:text-zinc-150">{item.label}</span>
                    <span className="text-xs text-zinc-450 dark:text-zinc-500 mt-0.5">{item.desc}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="flex justify-center -my-2 select-none">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-white dark:bg-[#17171a] border border-zinc-200 dark:border-[#2a2a2e] text-[#FF4F18] shadow-xs">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="px-2 py-0.5 rounded-md bg-orange-50 dark:bg-[#FF4F18]/15 text-[#FF4F18] text-xs font-bold uppercase tracking-wider border border-[#FF4F18]/20">
                    After
                  </span>
                  <h4 className="text-sm sm:text-base font-extrabold text-zinc-900 dark:text-white uppercase tracking-wider">
                    Connected. Simple. In Control.
                  </h4>
                </div>
                {/* Brand Logo marker */}
                <span className="text-xs font-extrabold text-[#FF4F18] uppercase tracking-widest bg-orange-50 dark:bg-[#FF4F18]/10 px-2.5 py-1 rounded-lg">
                  Digitory
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {afterItems.map((item, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-2 p-3.5 rounded-xl bg-white dark:bg-[#17171a] border border-zinc-200 dark:border-zinc-800 shadow-xs hover:border-[#FF4F18]/45 transition-all"
                  >
                    {item.icon}
                    <span className="text-xs sm:text-sm font-bold text-zinc-800 dark:text-zinc-200 leading-tight">
                      {item.label}
                    </span>
                  </div>
                ))}
            ...
            <div className="mt-2 rounded-2xl overflow-hidden border border-zinc-200 dark:border-[#2a2a2e] relative shadow-md">
              <div className="h-6 bg-zinc-200/50 dark:bg-[#1E1E24] px-4 flex items-center gap-1.5 border-b border-zinc-200 dark:border-zinc-900">
                <span className="w-2.5 h-2.5 rounded-full bg-zinc-300 dark:bg-zinc-700" />
                <span className="w-2.5 h-2.5 rounded-full bg-zinc-300 dark:bg-zinc-700" />
                <span className="w-2.5 h-2.5 rounded-full bg-zinc-300 dark:bg-zinc-700" />
                <span className="text-[10px] font-bold text-zinc-400 ml-2">digitory-dashboard.io</span>
              </div>
              <div className="bg-white dark:bg-[#151518] p-4 flex flex-col gap-3 min-h-[140px]">
                <div className="flex justify-between items-center">
                  <div className="space-y-1">
                    <span className="text-[10px] text-zinc-450 uppercase tracking-widest font-extrabold">Overall Status</span>
                    <h5 className="text-sm font-bold text-[#FF4F18] flex items-center gap-1">
                      <span className="w-2 h-2 rounded-full bg-[#FF4F18] animate-ping inline-block" />
                      All systems operating normally
                    </h5>
                  </div>
                  <span className="text-xs font-extrabold text-[#FF4F18] border border-[#FF4F18]/25 rounded-md px-2 py-0.5">Live</span>
                </div>
                <div className="grid grid-cols-3 gap-2 mt-1">
                  <div className="p-2.5 bg-zinc-50 dark:bg-[#1A1A1E] rounded-lg space-y-0.5">
                    <span className="text-[9px] text-zinc-400 block font-medium">Orders today</span>
                    <span className="text-sm font-bold text-zinc-950 dark:text-white">412</span>
                  </div>
                  <div className="p-2.5 bg-zinc-50 dark:bg-[#1A1A1E] rounded-lg space-y-0.5">
                    <span className="text-[9px] text-zinc-400 block font-medium">Net Sales</span>
                    <span className="text-sm font-bold text-zinc-950 dark:text-white">₹84,200</span>
                  </div>
                  <div className="p-2.5 bg-zinc-50 dark:bg-[#1A1A1E] rounded-lg space-y-0.5">
                    <span className="text-[9px] text-zinc-400 block font-medium">Table Wait Time</span>
                    <span className="text-sm font-bold text-zinc-950 dark:text-white">8.5 min</span>
                  </div>
                </div>
              </div>
            </div>
